...
In my off-work time I do actively develop and maintain some open-source software packages (C# and Python) under my _numbworks_ brand. Last but not least, to improve my craft, I studied 274 technical books in the past nine years.
...
| [nwtimetrackingmanager](https://github.com/numbworks/nwtimetrackingmanager) | 66 h | <ul><li>[README](https://github.com/numbworks/nwtimetrackingmanager/blob/master/README.md)</li> <li>[CHANGELOG](https://github.com/numbworks/nwtimetrackingmanager/blob/master/CHANGELOG)</li> <li>[Documentation](https://github.com/numbworks/nwtimetrackingmanager/blob/master/docs/docs-nwtimetrackingmanager.md)</li> <li>[Issues](https://github.com/numbworks/nwtimetrackingmanager/issues)</li></ul> | MIT | ![codecoverage.svg](https://raw.githubusercontent.com/numbworks/nwtimetrackingmanager/master/codecoverage.svg) | 2.2.0 | 2024-02-27 |
